...
def build_conditions(df):
    conditions = {
            "rule_001__n27__r0.963__s2.98":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 7.333) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["MACD_hist_3d_rank"] >= 0.71),
            "rule_002__n25__r0.960__s2.88":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 25.833) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["MACD_hist_3d_rank"] >= 0.71),
            "rule_003__n25__r0.960__s2.88":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 15.429) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["MACD_hist_3d_rank"] >= 0.71),
            "rule_004__n32__r0.906__s2.60":
                (df["today_pct"] >= 9.87) &
            ...
            "rule_005__n26__r0.923__s2.59":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["MACD_hist_3d_rank"] >= 0.611),
            "rule_006__n31__r0.903__s2.55":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 1.502) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["MACD_hist_3d_rank"] >= 0.71),
            "rule_007__n25__r0.920__s2.54":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 86.812) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["MACD_hist_3d_rank"] >= 0.611),
            "rule_008__n29__r0.897__s2.45":
                (df["today_pct"] >= 9.87) &
            ...
            "rule_058__n28__r0.857__s2.12":
                ...
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 5.181),
            "rule_059__n28__r0.857__s2.12":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 6.015),
            "rule_060__n28__r0.857__s2.12":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 6.779),
            "rule_061__n28__r0.857__s2.12":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 7.473),
            "rule_062__n28__r0.857__s2.12":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 8.148),
            "rule_063__n28__r0.857__s2.12":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 8.84),
            "rule_064__n28__r0.857__s2.12":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 9.524),
            "rule_065__n28__r0.857__s2.12":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 10.222),
            "rule_066__n28__r0.857__s2.12":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 11.06),
            "rule_067__n28__r0.857__s2.12":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
            ...
            "rule_106__n27__r0.852__s2.06":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= -4.083) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["MACD_acc"] >= 18.238),
            "rule_107__n27__r0.852__s2.06":
                (df["MACD_hist_3d_rank"] >= 0.71) &
                (df["dist_from_low_20d"] >= 22.317) &
                (df["trend_signal_pct"] <= -4.083) &
                (df["MACD_acc"] <= 87.776),
            "rule_108__n27__r0.852__s2.06":
                (df["trend_signal_pct"] >= -21.917) &
            ...
            "rule_115__n26__r0.846__s2.00":
                ...
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 11.92),
            "rule_116__n26__r0.846__s2.00":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
                (df["dist_from_low_20d"] >= 12.852),
            "rule_117__n26__r0.846__s2.00":
                (df["today_pct"] >= 9.87) &
                (df["trend_signal_pct"] >= 58.342) &
                (df["tr_value_ratio"] <= 1.345) &
