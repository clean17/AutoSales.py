...
def search_rules_train_only(
    ...
    atoms = make_atoms(train, features, profile["quantiles"])
...
def print_recommended_features(final_df):
    ...
    usable = usable[
        usable["corr_prune_status"] != "CORRELATED_DROP"
        ]
...
# 실행 방법
#  python feature_selector_v2.py   --csv csv/low_result_7_desc.csv   --out feature_selector_v2_out   --max-depth 4   --beam-width 300   --top-k 150   --top-n-usage 50   --top-n-loo 20   --corr-threshold 0.90