...
# df = df.drop(columns=["MACD_hist_3d"], errors="ignore")
# df = df.drop(columns=["today_tr_val_eok"], errors="ignore")
# df = df.drop(columns=["tr_val_rank_20d"], errors="ignore")
# df = df.drop(columns=["tr_value_ratio_5d"], errors="ignore")
